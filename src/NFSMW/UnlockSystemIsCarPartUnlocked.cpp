#include "UnlockSystemIsCarPartUnlocked.hpp"

#include "../dllmain.hpp"

namespace UnlockSystemIsCarPartUnlocked {

    namespace {

        constexpr Memory::Pattern kIsCarPartUnlocked =
            Memory::ParsePattern("51 A0 ?? ?? ?? ?? 84 C0 74 04 B0 01 59 C3 53 8B 5C 24 0C F6 C3 01 "
                                 ...
                                 "8B 44 24 24 55 50 56 57 53 E8 16 F7 FF FF");
    ...
    bool Install() noexcept {
        return Hook::Patch(g_patch, kIsCarPartUnlocked, 0, kUnlocked);
    }
